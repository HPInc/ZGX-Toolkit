...
describe('TelemetryService', () => {
    ...
    describe('Track Event - Enabled', () => {
        it('should send telemetry event when enabled and reporter present', () => {
            telemetryService.setEnabled(true);
            telemetryService.trackEvent({
                eventType: TelemetryEventType.Command,
                action: 'execute',
    ...
    describe('Track Error - Enabled', () => {
        it('should send telemetry error event when enabled and reporter present', () => {
            telemetryService.setEnabled(true);
            const error = new Error('Test error');
            telemetryService.trackError({
                eventType: TelemetryEventType.Error,
            ...
            expect(mockSendTelemetryErrorEvent).toHaveBeenCalledWith(
                TelemetryEventType.Error,
                { errorMsg: 'Test error', context: 'ctx' }
            );
        });
    });

    describe('Dispose', () => {
        it('should dispose the reporter and clear the reference', async () => {
