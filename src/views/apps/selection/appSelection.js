...
(function() {
    ...
    function handleRefresh() {
        ...
        // Mark that we're starting verification
        isVerifying = true;
    ...
    window.addEventListener('message', function(event) {
        ...
        switch (message.type) {
            ...
            case 'cancel-verification':
                // Backend is cancelling verification due to health check failure
                if (isVerifying) {
                    handleVerificationCancelled();
                }
                break;
            ...
            case 'show-error-overlay':
                // Cancel any ongoing verification since device is unhealthy
                if (isVerifying) {
                    handleVerificationCancelled();
                }
