...
/**
 * Configuration keys and default values for the Z Toolkit extension.
 ...
 */
export const CONFIG_SECTION = 'zToolkit' as const;

/** Previous configuration section, used for one-time settings migration. */
export const LEGACY_CONFIG_SECTION = 'zgxToolkit' as const;
...
export const CONFIG_KEYS = {
    ...
    LOG_LEVEL: 'zToolkit.logLevel',
    /** Whether telemetry is enabled */
    TELEMETRY_ENABLED: 'zToolkit.telemetry.enabled',
 ...
 */
export const URLS = {
    /** Z Toolkit documentation wiki */
    ZGX_DOCS: 'https://github.com/HPInc/ZGX-Toolkit/wiki',
    /** HP Z Runtime (ZRT) documentation */
    ZRT_LEARN_MORE: 'https://www.hp.com/zrt'
} as const;
